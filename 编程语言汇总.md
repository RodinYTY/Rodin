...
| :-------: | :---- | :----------------------------------------------------------- | :---- | :----- |
| 文件目录  |       | [[NSBundle mainBundle] bundlePath]<br />NSSearchPathForDirectoriesInDomains(NSDocument/Library/CachesDirectory, NSUserDomainMask, YES) -> array<br /> |       |        |
...
| 遍历       |                                                              | for(id t in array){...}<br />[arr makeObjectsPerformSelector: withObject:] |                                                              |                                                              |
...
| 排序       |                                                              | sortedArrayUsingDescriptors:[NSDescriptor sortDescriptorWithKey: @"name" ascending:YES] | .sorted(isOrderedBefore:<)                                   | sorted(a)<br />a.sort(reverse=True)                          |
